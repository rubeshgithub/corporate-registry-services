...
section: "articles"
description: "Ontario incorporation costs $300 in government fees plus a NUANS report — DIY vs. lawyer vs. CRS at {{price:incorporation-numbered}} all-in. Every fee, deadline and hidden cost, 2026."
faq:
  - q: "How much does it cost to incorporate in Ontario?"
    a: "The Ontario government charges $300 to file Articles of Incorporation through the Ontario Business Registry. Named corporations also need an Ontario-biased NUANS report, typically $20–$60 from a search house. A do-it-yourself numbered company can therefore cost as little as $300; a lawyer-prepared incorporation commonly runs $1,000–$2,500; CRS files the whole thing for {{price:incorporation-numbered}} all-in + tax including the government fee, NUANS and a full minute book."
...
CRS includes the NUANS report and the preliminary name check in its {{price:incorporation-numbered}} all-in price. See our [NUANS name search guide](/guides/nuans-name-search-canada-guide) for how the report works and what a "conflict" actually means.
...
| **CRS (registry agent)** | {{price:incorporation-numbered}} all-in + tax | Government fee, NUANS report, customised Articles, by-laws, first directors' and shareholders' resolutions, share certificates, registers, BN application, digital minute book | Not a law firm — complex share structures and shareholder agreements go to a lawyer |
...
- **Corporate records upkeep.** Directors' and shareholders' resolutions for dividends, officer changes and the annual approval of financial statements belong in the minute book. CRS drafts [director resolution sets from {{price:shareholder-resolution}} + GST](/order/director-resolution).
...
Over five years the two routes cost roughly the same in government fees. Choose on strategy, not the $100 difference. Our [federal vs. provincial incorporation guide](/articles/federal-vs-provincial-incorporation-canada) walks through the decision, and CRS files either for the same {{price:incorporation-numbered}} all-in.
...
**Price:** {{price:incorporation-numbered}} all-in + tax — includes the $300 government fee, NUANS report, by-laws, resolutions, share certificates and Business Number application.
