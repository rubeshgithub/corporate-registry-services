...
faq:
  ...
  - q: "What is 'cross-Canada name protection' and why does it matter?"
    a: "When you incorporate federally, your NUANS name search reserves your corporate name across all of Canada — no other corporation can register the same or a confusingly similar name in any province or territory. A provincial incorporation only reserves the name within that one province. For businesses with national ambitions, cross-Canada name protection prevents a competitor from later registering your name in a different province and forcing an expensive rebrand."
  - q: "Federal or provincial — which is better if I'm raising VC?"
    a: "Many Canadian and US-based institutional investors default to CBCA (federal) for portfolio companies because the statute is well-understood by cross-border deal counsel, and the Articles are more standardised across firms. If you're raising national or US-connected capital, federal is a safe default. If your investors are provincially-scoped (e.g., Ontario angels investing in Ontario startups), OBCA can be equally acceptable. Ask your investors on the consultation call — they usually have a preference and it's cheap to align at incorporation."
...
**Cross-Canada name protection.** A federal NUANS search reserves your corporate name across all 13 provinces and territories. A provincial name search only protects the name within that one province — meaning a competitor in another province could later register an identical or confusingly similar name and force you into an expensive rebrand or trademark fight. For any business with national ambitions, federal name protection is the biggest single reason to pick CBCA.

**Preferred by institutional investors and cross-border deals.** Canadian and US-based VCs, private equity firms, and corporate lenders often prefer CBCA portfolio companies because the statute is well-understood by cross-border deal counsel, the Articles of Incorporation follow standard patterns across firms, and closing paperwork tends to be smoother. If you're raising national or US-connected capital, federal is a safe default.

**Portable across all Canadian jurisdictions.** A federal corporation can register as extra-provincial in any province without re-incorporating. This is especially valuable for businesses that start regional but plan to expand, or that operate in industries with unpredictable geography (SaaS, e-commerce, professional services).

**Access to federal programs and grants.** SR&ED tax credits, federal innovation programs, government procurement contracts, and various sector-specific grants often have federal-corporation preferences or eligibility criteria.

**Prestige and credibility.** For B2B enterprise sales, government contracts, or international partnerships, a federal corporation registered with Corporations Canada carries more implicit weight than a small provincial corporation. This is soft but real.

## Federal incorporation requirements

Under the *Canada Business Corporations Act*:

- **Articles of Incorporation** (CBCA Form 1) — the founding document.
- **Notice of Directors** (Form 6) — names, addresses, and Canadian residency status of each initial director.
- **Notice of Registered Office** (Form 3) — physical address in Canada (not a PO box).
- **NUANS report** — mandatory for named corporations; reserves the name nationally for 90 days.
...
- Direct filing with Corporations Canada on your behalf
...
Standard CRS turnaround for a CBCA incorporation:

- **Day 1 (order received):** We confirm your intended names, director list (with Canadian residency status), registered office, and share structure. Preliminary name check.
- **Day 1–2:** NUANS name search filed nationally. Articles of Incorporation drafted.
- **Day 2:** Names cleared. Articles filed online with Corporations Canada.
- **Day 3–5:** Certificate of Incorporation issued (typically 24–48 hours after filing). Minute book, share certificates, and organizational resolutions delivered as signable PDFs. BN application submitted to the CRA.

Total: **typically 3–5 business days** end-to-end. Corporations Canada is among the fastest registries in the country.
...
## Federal or provincial? Not sure yet — book a free consultation

Not sure whether federal (CBCA) or a specific province is the right jurisdiction? A CRS incorporation specialist walks through your operations, expansion plans, investor makeup, director residency, and name protection needs. Free 15-minute call, no obligation.
