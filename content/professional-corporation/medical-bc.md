---
title: "Medical Professional Corporation BC — {{price:pc-setup}} + Fees"
h1: "Health Profession Corporation BC: CPSBC Permit Guide 2026"
metaDescription: "CPSBC permit: C$350 per physician to apply, C$135 a year, renew by March 1 — name approval first. We set up your corporation for {{price:pc-setup}} + gov't fees."
slug: "/professional-corporation/medical-bc"
primaryKeyword: "health profession corporation BC"
secondaryKeywords: ["CPSBC corporation permit", "doctor incorporation BC", "medical professional corporation British Columbia", "HPOA health profession corporation", "CPSBC permit renewal"]
...
# Health Profession Corporation in BC: CPSBC Permit Guide for Physicians
...
One point of currency matters more than any other in 2026: the governing statute is now the *Health Professions and Occupations Act* (HPOA, SBC 2022, c. 43), which [replaced the *Health Professions Act* on April 1, 2026](https://www2.gov.bc.ca/gov/content/health/practitioner-professional-resources/professional-regulation/health-professions-and-occupations-act). A great deal of online guidance — including recent posts from incorporation services — still cites the repealed HPA and old bylaw numbering. CPSBC's permit regime, from name approval to shareholder eligibility, now runs on the [HPOA](https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/22043) and CPSBC Bylaws Part 7, and your articles and application must match that framework.
...
1. **Get the corporate name approved by CPSBC first** — submit the Name Approval Request Form to pmcapp@cpsbc.ca; the College confirms it complies with the HPOA and section 7-6 of its bylaws.
...
Before anything goes to BC Registries, get the corporate name approved by CPSBC. You submit the college's Name Approval Request Form by email (pmcapp@cpsbc.ca), and CPSBC confirms the name complies with the HPOA and section 7-6 of its bylaws. Only then should you [reserve the name with BC Registries](https://www2.gov.bc.ca/gov/content/employment-business/business/managing-a-business/permits-licences/businesses-incorporated-companies/incorporated-companies) ($30, or $100 for one-to-two-day priority review) — the reservation holds for 56 days.
...
With the certificate of incorporation issued, the [permit application package](https://www.cpsbc.ca/registrants/current-registrants/pmc/new-corporation) goes to CPSBC by email. Per the college's [Health Profession Corporation Permit Application](https://www.cpsbc.ca/files/pdf/HPC-F-Permit-Application.pdf), a complete application includes:
...
- the certificate of incorporation and proof the company is in good standing under the *Business Corporations Act* — a current [corporate profile report](/profile-reports) is the fastest way to evidence this; and
...
Two renewal tracks, two deadlines. At the registry, the corporation must file a BC annual report ($43.39) within two months of each incorporation anniversary; miss it for two consecutive years and the company can be dissolved. At the college, the [permit expires on the last day of February every year](https://www.cpsbc.ca/registrants/current-registrants/pmc/renewing-corporation-permit) and must be renewed before March 1 with fresh attestations of HPOA and bylaw compliance, disclosure of any changes, and the C$135 annual fee. Renew late and a C$100 penalty applies; let it slide past May 1 and the permit must be reinstated as if it were a brand-new application — during which time the corporation cannot provide health services at all. Our [renewals guide](/professional-corporation/renewals) shows how to run both calendars off one plan.
...
Government and college fees total roughly $865 in year one for a single physician: $30 name request and $350 incorporation at BC Registries, then C$350 per licensee to apply for the CPSBC permit plus the C$135 annual permit fee. Ongoing years cost C$135 plus the $43.39 BC annual report. CRS's setup service is {{price:pc-setup}} + GST on top of those fees, which are passed through at cost.
...
- [Professional Corporations in British Columbia](/professional-corporation/british-columbia)
