...
The 30-day windows make sequencing matter: order the certificate of status last, immediately before you submit. We can obtain a fresh certificate of status and a current [corporate profile report](/profile-reports) the same day your application package is ready to go, so nothing in the file goes stale.
