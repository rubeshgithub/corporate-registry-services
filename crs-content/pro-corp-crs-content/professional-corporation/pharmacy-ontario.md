...
# Pharmacy Professional Corporation in Ontario: OCP Certificate of Authorization Guide
...
With the certificate of incorporation in hand, the corporation applies to OCP for its **certificate of authorization**. The [application package](https://ocpinfo.com/ocp-resources/application-for-certificate-of-authorization-for-a-health-profession-corporation/) must include:
...
- the application fee set out in [OCP's Schedule of Fees](https://ocpinfo.com/ocp-resources/schedule-of-fees/) (line 42 — confirm the current amount before filing, as the schedule is updated annually).

The 30-day windows make sequencing matter: order the certificate of status last, immediately before you submit. We can obtain a fresh certificate of status and a current [corporate profile report](/corporate-profile-report) the same day your application package is ready to go, so nothing in the file goes stale.
...
**OCP track.** The certificate of authorization must be renewed **on or before March 10** each year; the College notifies corporation directors in January. Per the [annual renewal form](https://ocpinfo.com/ocp-resources/annual-renewal-for-a-certificate-of-authorization-for-a-professional-corporation/), the package is: the renewal form and shareholder undertaking signed within 30 days of submission, a director's declaration, a **corporation profile report from the Ministry dated within 30 days** confirming the corporation is active, any endorsed certificates if the articles or name changed during the year, and the **$512.90 renewal fee (HST included)**. Renewals go to pharmacyapplications@ocpinfo.com. A lapsed certificate means the pharmacist can no longer practise through the corporation.
...
Our [professional corporation renewals guide](/professional-corporation/renewals) lays out both calendars, and we can supply the fresh corporation profile report OCP requires with each renewal.
