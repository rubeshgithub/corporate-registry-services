...
export const NAME_SEARCH_CONFIGS: Record<NameSearchServiceKey, NameSearchServiceConfig> = {
  "corporate-search": {
    ...
    headline:          "Check your business name is available before you file",
    description:       "A pre-screen of the government registry to confirm a proposed name is available in a specific province. Run this before you commit to a name — if you then need the official federal NUANS report for a CBCA incorporation or name change, order the NUANS report.",
    needsJurisdiction: true,
    priceLabel:        "$49 all-in + GST",
    priceCents:        4900,
    buttonLabel:       "Pay $49 + GST and check the name",
    productName:       "Name Availability - NUANS - Pre-Screen Name Search",
    productBlurb:      "Government-direct name availability pre-screen. Delivered by email within one business hour.",
