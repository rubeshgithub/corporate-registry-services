...
export const PRO_CORP_SERVICES: Record<ProCorpServiceKey, ProCorpService> = {
  ...
  "setup": {
    ...
    priceCents: 49900,
    priceLabel: "$499 + GST, plus government fees",
    blurb:      "Flat $499 service fee: name reservation, articles, by-laws, coordination with your regulator, and filing. Government registry and regulator fees are extra, at cost — itemized before you pay.",
